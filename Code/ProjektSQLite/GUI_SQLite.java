...
public class GUI_SQLite extends Frame {
  ...
  public void btStart_ActionPerformed(ActionEvent evt) {
    //Vorsicht! MySQL-Treiber muss im Projekt eingebunden sein!
    //dazu unter Fenster-Konfiguration-Java-Interpreter die jar-Datei unter Classpath-User laden!
    //im Übrigen user root ohne Passwort standardmäßig bei MySQL angelegt! 
    myDatabase = new DatabaseConnector("localhost",3306,"bank","root","");
