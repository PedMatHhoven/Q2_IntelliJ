...
public class Controller {
    ...
    public void start(Event e) {
        if (e.getSource() == btn_Spielen){
            eingabe = Automat.tEingabe.Spielen;
            ein_aus_zus = automat.uebergangsfunktion(eingabe, automat.getZustand());
        }
        if (e.getSource() == btn_Abbruch){
            eingabe = Automat.tEingabe.Abbruch;
            ein_aus_zus = automat.uebergangsfunktion(eingabe, automat.getZustand());
        }
        if (e.getSource() == btn_Einzahlen){
            eingabe = Automat.tEingabe.Einzahlen;
            ein_aus_zus = automat.uebergangsfunktion(eingabe, automat.getZustand());
        }
        if (e.getSource() == btn_Gewinnen){
            eingabe = Automat.tEingabe.Gewinnen;
            ein_aus_zus = automat.uebergangsfunktion(eingabe, automat.getZustand());
        }
        if (e.getSource() == btn_Verlieren){
            eingabe = Automat.tEingabe.Verlieren;
            ein_aus_zus = automat.uebergangsfunktion(eingabe, automat.getZustand());
        }
